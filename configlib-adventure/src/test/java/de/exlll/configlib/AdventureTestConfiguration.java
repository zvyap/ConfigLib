...
public class AdventureTestConfiguration {
    ...
    Component decoratedText = Component.text("Bold Italic", NamedTextColor.BLUE, TextDecoration.BOLD,
    ...
    Component rainbowText = MiniMessage.miniMessage().deserialize("<rainbow>Rainbow</rainbow>");
    Component formattedText = MiniMessage.miniMessage().deserialize(
            "<bold>Bold</bold> <italic>Italic</italic> <underlined>Underlined</underlined> <strikethrough>Strike</strikethrough> <obfuscated>Obfuscated</obfuscated>");
    Component clickText = MiniMessage.miniMessage().deserialize("<click:run_command:/test>Click Command</click>");
    ...
    Component keybindText = MiniMessage.miniMessage().deserialize("<key:key.code>");
    Component translatableText = MiniMessage.miniMessage().deserialize("<lang:block.minecraft.stone>");

    Key simpleKey = Key.key("namespace", "value");

    Sound simpleSound = Sound.sound(Key.key("minecraft:entity.player.levelup"), Sound.Source.MASTER, 1f, 1f);
    ...
    Map<String, Component> componentMap = Map.of(
            "welcome", Component.text("Welcome!"),
