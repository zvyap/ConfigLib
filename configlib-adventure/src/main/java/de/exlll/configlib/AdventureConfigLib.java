...
public final class AdventureConfigLib {
    private static final List<ComponentFormat> DEFAULT_FORMAT_ORDER = List.of(
            ComponentFormat.MINI_MESSAGE // Use MiniMessage as the default format since MiniMessage covered all component type
    );

    private AdventureConfigLib() {
    }

    public static <B extends ConfigurationProperties.Builder<B>> ConfigurationProperties.Builder<B> addDefaults(ConfigurationProperties.Builder<B> builder) {
